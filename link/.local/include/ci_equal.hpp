...
bool ci_equal(const std::basic_string<CharT, Traits, Allocator>& s1,
...
/// case-insensitive equal strings
template <character CharT>
bool ci_equal(const CharT* s1, const CharT* s2)
{
...
/// case-insensitive equal strings (with locale)
template <character CharT>
bool ci_equal(const CharT* s1, const CharT* s2, const std::locale& loc)
{
