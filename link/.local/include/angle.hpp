...
constexpr int sextants_per_rev = 6;
constexpr int octants_per_rev = 8;
constexpr int hexacontades_per_rev = 60;
constexpr int binary_degrees_per_rev = 256;
