...
template <typename T>
struct is_narrow_character_ptr : std::bool_constant<std::is_pointer_v<T> &&
                                 is_narrow_character_v<std::remove_pointer_t<T>>>
{};
...
template <typename T>
struct is_wide_character_ptr : std::bool_constant<std::is_pointer_v<T> &&
                                 is_wide_character_v<std::remove_pointer_t<T>>>
{};
