...
/* Here are different primes randomly generated with the equal
   ...
   values.  */
inline constexpr uint64_t _mum_hash_step_prime = 0x2e0bb864e9ea7df5;
inline constexpr uint64_t _mum_key_step_prime = 0xcdb32970830fcaa1;
inline constexpr uint64_t _mum_block_start_prime = 0xc42b5e2e6480b23b;
inline constexpr uint64_t _mum_unroll_prime = 0x7b51ec3d22f7096f;
